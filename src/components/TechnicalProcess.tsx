          ...
          >
            <div className="flex gap-6">
              ...
              <div className="relative flex-shrink-0">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-gold-400 to-gold-500 flex items-center justify-center font-bold text-navy-950 text-lg shadow-lg shadow-gold-400/20">
                  {index + 1}
                </div>
              </div>

              {/* Phase content */}
              <div className="flex-1 glass rounded-2xl p-6 border border-gold-400/10 hover:border-gold-400/20 transition-all duration-300">
                ...
                <div className="space-y-2 mt-4">
                  <div className="text-sm font-medium text-gold-400 mb-2">
                    Key Outcomes:
                  </div>
